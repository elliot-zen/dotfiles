...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    ...
    loaded = true,
    path = "/home/elliot/.local/share/nvim/site/pack/packer/start/Comment.nvim",
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/home/elliot/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
  ...
  ["cmp-path"] = {
    loaded = true,
    path = "/home/elliot/.local/share/nvim/site/pack/packer/start/cmp-path",
    url = "https://github.com/hrsh7th/cmp-path"
  },
  cmp_luasnip = {
    loaded = true,
    path = "/home/elliot/.local/share/nvim/site/pack/packer/start/cmp_luasnip",
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/elliot/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
